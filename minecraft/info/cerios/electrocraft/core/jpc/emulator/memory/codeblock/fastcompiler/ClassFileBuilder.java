...
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.CodeBlock;
...
public class ClassFileBuilder {
    ...
    static {
        try {
            realModeSkeleton = loadSkeletonClass(info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.real.RealModeSkeletonBlock.class);
            virtual8086ModeSkeleton = loadSkeletonClass(info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.virt.Virtual8086ModeSkeletonBlock.class);
            protectedModeSkeleton = loadSkeletonClass(info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.prot.ProtectedModeSkeletonBlock.class);
        } catch (IOException e) {
