...
package info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler;

import java.io.*;
import java.util.*;
import java.util.logging.*;

import info.cerios.electrocraft.core.jpc.emulator.processor.ProcessorException;
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.*;
import info.cerios.electrocraft.core.jpc.classfile.*;
import info.cerios.electrocraft.core.jpc.classfile.attribute.CodeAttribute;

import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.real.*;
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.prot.*;
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.virt.*;
...
//    }
    ...
    public ProtectedModeCodeBlock compileProtectedModeBlock(String className, InstructionSource source)
    {
        ...
        try
        {
            ...
            if (className == null)
            {
                className = "info.cerios.electrocraft.core.jpc.dynamic.FAST_PM_" + getHash(newMicrocodes);
            }
            try
            {
    ...
    public RealModeCodeBlock compileRealModeBlock(String className, InstructionSource source)
    {
        ...
        try
        {
            ...
            if (className == null)
            {
                className = "info.cerios.electrocraft.core.jpc.dynamic.FAST_RM_" + getHash(newMicrocodes);
            }
            try
            {
                Class oldClass = Class.forName(className, true, ClassFileBuilder.getClassloader());
    ...
    public Virtual8086ModeCodeBlock compileVirtual8086ModeBlock(String className, InstructionSource source)
    {
        ...
        try
        {
            ...
            if (className == null)
            {
                className = "info.cerios.electrocraft.core.jpc.dynamic.FAST_VM_" + getHash(newMicrocodes);
            }
            try
            {
                Class oldClass = Class.forName(className, true, ClassFileBuilder.getClassloader());
