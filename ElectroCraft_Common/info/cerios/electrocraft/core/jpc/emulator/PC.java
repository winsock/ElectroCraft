...
import info.cerios.electrocraft.core.jpc.emulator.pci.*;
import info.cerios.electrocraft.core.jpc.emulator.peripheral.*;
import info.cerios.electrocraft.core.jpc.emulator.processor.*;
import info.cerios.electrocraft.core.jpc.support.*;
import java.io.*;
import java.net.URL;
...
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.CodeBlockManager;
...
public class PC implements IComputer {
    ...
    public PC(Clock clock, DriveSet drives) throws IOException {
        ...
        parts.add(new DefaultVGACard(AbstractElectroCraftMod.getInstance().getComputerHandler()));
        ...
        //BIOSes
        parts.add(new SystemBIOS("/info/cerios/electrocraft/core/jpc/resources/bios/bios.bin"));
        parts.add(new VGABIOS("/info/cerios/electrocraft/core/jpc/resources/bios/vgabios.bin"));
     ...
     */
    public void changeFloppyDisk(info.cerios.electrocraft.core.jpc.support.BlockDevice disk, int index) {
