...
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.optimised.MicrocodeSet;
import info.cerios.electrocraft.core.jpc.classfile.JavaOpcode;
...
public class UCodeMethodParser
{
	...
	boolean explicitThrow = false;
	    ...
	    if (c == info.cerios.electrocraft.core.jpc.emulator.processor.ProcessorException.class) {
		explicitThrow = true;
		break;
	    }
	}
