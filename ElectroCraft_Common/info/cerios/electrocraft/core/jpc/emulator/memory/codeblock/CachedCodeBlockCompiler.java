...
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.FASTCompiler;
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.prot.ProtectedModeTemplateBlock;
import info.cerios.electrocraft.core.jpc.emulator.memory.codeblock.fastcompiler.real.RealModeTemplateBlock;
...
public class CachedCodeBlockCompiler implements CodeBlockCompiler
{
    ...
    public RealModeCodeBlock getRealModeCodeBlock(InstructionSource source)
    {
        try
        {
            ...
            String className = "info.cerios.electrocraft.core.jpc.dynamic.FAST_RM_" + FASTCompiler.getHash(newMicrocodes);
    ...
    public ProtectedModeCodeBlock getProtectedModeCodeBlock(InstructionSource source)
    {
        ...
        {
            int[] newMicrocodes = getMicrocodesArray(source);
            String className = "info.cerios.electrocraft.core.jpc.dynamic.FAST_PM_" + FASTCompiler.getHash(newMicrocodes);
            Class oldClass = Class.forName(className);
