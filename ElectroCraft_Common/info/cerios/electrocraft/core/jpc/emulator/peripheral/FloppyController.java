...
package info.cerios.electrocraft.core.jpc.emulator.peripheral;
...
public class FloppyController implements IOPortCapable, DMATransferCapable, HardwareComponent, TimerResponsive
{
    ...
    public void changeDisk(info.cerios.electrocraft.core.jpc.support.BlockDevice disk, int i)
    {
    ...
    static class FloppyDrive implements Hibernatable
    {
        ...
        private void changeDisk(info.cerios.electrocraft.core.jpc.support.BlockDevice disk)
        {
            device = disk;
            revalidate();
        }
