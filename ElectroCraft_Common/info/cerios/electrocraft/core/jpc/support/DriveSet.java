...
public class DriveSet extends AbstractHardwareComponent
{
    ...
    private static enum Devices {
        DEFAULT("info.cerios.electrocraft.core.jpc.support.FileBackedSeekableIODevice"),
        
        dir("info.cerios.electrocraft.core.jpc.support.TreeBlockDevice"),
        mem("info.cerios.electrocraft.core.jpc.support.ArrayBackedSeekableIODevice"),
        net("info.cerios.electrocraft.core.jpc.support.RemoteSeekableIODevice");
