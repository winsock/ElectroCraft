...
public enum ElectroBlocks {
    ...
    MAGNETITE_ORE(true, "magnetiteOre", "Magnetite Ore", new MagnetiteOre(ConfigHandler.getCurrentConfig().get("block", "magnetiteOre", 3976).getInt(3976)).setBlockName("magnetiteOre").setCreativeTab(CreativeTabs.tabMaterials), null, null, 4), COMPUTER(true, "xcomputer", "Computer", new BlockComputer(ConfigHandler.getCurrentConfig().get("block", "xcomputer", 3977).getInt(3977)).setBlockName("xcomputer").setCreativeTab(CreativeTabs.tabRedstone), null, TileEntityComputer.class, 32, 37), REDSTONE_ADAPTER(true, "redstoneAdapter", "Redstone Adapter", new BlockRedstoneAdapter(ConfigHandler.getCurrentConfig().get("block", "redstoneAdapter", 3980).getInt(3980)).setBlockName("redstoneAdapter").setCreativeTab(CreativeTabs.tabRedstone), null, TileEntityRedstoneAdapter.class, 149, 148, 147, 147, 147, 147), SERIAL_CABLE(false, "serialcable", "Serial Cable", new BlockSerialCable(ConfigHandler.getCurrentConfig().get("block", "serialCable", 3981).getInt(3981)).setBlockName("serialCable").setCreativeTab(CreativeTabs.tabRedstone), null, TileEntitySerialCable.class, 0);
