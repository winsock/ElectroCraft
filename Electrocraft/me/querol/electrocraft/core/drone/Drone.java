...
import me.querol.electrocraft.api.utils.ObjectPair;
import me.querol.electrocraft.core.ElectroCraft;
import me.querol.electrocraft.core.computer.Computer;
import me.querol.electrocraft.core.drone.tools.SwordTool;
...
public class Drone extends Computer {
    ...
    public void initComputer() {
        ...
        this.luaState.register("drone", droneAPI, true);
        luaState.pop(1);
        if (luaState != null && luaState.isOpen() && leftCard != null) {
            luaState.register(leftCard.getValue1().getName(leftCard.getValue2()), leftCard.getValue1().getFunctions(leftCard.getValue2(), this), true);
            luaState.pop(1);
        }
        if (luaState != null && luaState.isOpen() && rightCard != null) {
            luaState.register(rightCard.getValue1().getName(rightCard.getValue2()), rightCard.getValue1().getFunctions(rightCard.getValue2(), this), true);
            luaState.pop(1);
        }
    }
    ...
    public void setLeftCard(ICard card, ItemStack stack) {
        ...
        if ((leftCard == null || (card != leftCard.getValue1() && luaState != null && luaState.isOpen())) && card != null && luaState != null) {
            luaState.register(card.getName(stack), card.getFunctions(stack, this), true);
