...
import me.querol.electrocraft.api.drone.upgrade.ICard;
import me.querol.electrocraft.core.ElectroCraft;
import me.querol.electrocraft.core.drone.Drone;
...
public class ItemDroneUpgrade extends Item implements ICard {
    ...
    public String getUnlocalizedName(ItemStack stack) {
        switch (stack.getItemDamage()) {
            case 0:
                return "me.querol.electrocraft.items.gyro";
            case 1:
                return "me.querol.electrocraft.items.gps";
            case 2:
                return "me.querol.electrocraft.items.anaylzer";
            case 3:
                return "me.querol.electrocraft.items.engine";
            case 4:
                return "me.querol.electrocraft.items.ai";
        }
        return "";
    }
        ...
        switch (stack.getItemDamage()) {
            ...
            case 3:
                return new NamedJavaFunction[] { new NamedJavaFunction() {
                    ...
                    @Override
                    public int invoke(LuaState luaState) {
                        drone.setFlying(luaState.toBoolean(-1));
                        return 0;
                    }
