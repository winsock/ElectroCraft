...
public abstract class ElectroPacket {
	...
	public enum Type {
		MODIFIER(ModifierPacket.class), GUI(GuiPacket.class), ADDRESS(
				NetworkAddressPacket.class), INPUT(ComputerInputPacket.class), PORT(
				ServerPortPacket.class), CUSTOM(CustomPacket.class);
	...
	public static ElectroPacket readMCPacket(Packet250CustomPayload packet)
			throws IOException {
