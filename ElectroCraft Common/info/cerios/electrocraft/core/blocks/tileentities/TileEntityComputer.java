...
@ExposedToLua
public class TileEntityComputer extends NetworkBlock implements
		IDirectionalBlock, IComputerHost {
	...
	public void writeToNBT(NBTTagCompound nbttagcompound) {
		...
		if (computer != null && computer.isRunning()) {
			...
			if (computer.getProgramStorage() != null) {
				nbttagcompound.setTag("programStorage",
						computer.getProgramStorage());
			}
	...
	public void readFromNBT(NBTTagCompound nbttagcompound) {
		...
		this.direction = ForgeDirection.values()[nbttagcompound
		...
		if (nbttagcompound.getBoolean("isOn") && !loadingState) {
			...
			computer.setProgramStorage((NBTTagCompound) nbttagcompound
					.getTag("programStorage"));
			computer.callLoad();
	...
	public void createComputer() {
		...
		if (this.baseDirectory.isEmpty()) {
			...
			this.id = String.valueOf(Math.abs(this.xCoord))
					+ String.valueOf(Math.abs(this.yCoord))
					+ String.valueOf(Math.abs(this.zCoord))
					+ String.valueOf(Calendar.getInstance().getTime().getTime());
			this.baseDirectory = ElectroCraft.electroCraftSided.getBaseDir()
					.getAbsolutePath()
					+ File.separator
					+ worldDir
					+ File.separator
