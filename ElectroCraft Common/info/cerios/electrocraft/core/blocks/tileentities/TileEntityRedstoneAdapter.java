	...
	public void updateEntity() {
		...
		if (outputChanged) {
			...
			worldObj.notifyBlocksOfNeighborChange(xCoord, yCoord, zCoord,
					ElectroBlocks.REDSTONE_ADAPTER.getBlock().blockID);
			outputChanged = false;
		}
		if (externalPower != worldObj.isBlockIndirectlyGettingPowered(xCoord,
				yCoord, zCoord)) {
			setExternalState(worldObj.isBlockIndirectlyGettingPowered(xCoord,
					yCoord, zCoord));
		}
	}
