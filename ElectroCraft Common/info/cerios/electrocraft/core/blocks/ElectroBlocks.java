...
public enum ElectroBlocks {
    ...
    COMPUTER(true,
		    "xcomputer", "Computer",
		    new BlockComputer(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("xcomputer", 3978).getInt(3978)).setBlockName("xcomputer").setCreativeTab(CreativeTabs.tabRedstone),
