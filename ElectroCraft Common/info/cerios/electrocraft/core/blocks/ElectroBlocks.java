...
public enum ElectroBlocks {
    ...
    COMPUTER(true,
            "xcomputer", "Computer",
            new BlockComputer(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("xcomputer", 3977).getInt(3977)).setBlockName("xcomputer").setCreativeTab(CreativeTabs.tabRedstone),
