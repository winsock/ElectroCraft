...
public enum ElectroBlocks {
    ...
    COPPER_ORE(true,
            ...
            new CopperOre(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("copperOre", 139).getInt(3974)).setBlockName("copperOre").setCreativeTab(CreativeTabs.tabMaterials),
            null, null,
            3),
    MAGNETITE_ORE(true,
            "magnetiteOre", "Magnetite Ore",
            new MagnetiteOre(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("magnetiteOre", 140).getInt(3976)).setBlockName("magnetiteOre").setCreativeTab(CreativeTabs.tabMaterials),
            null, null,
            4),
    COMPUTER(true,
            "xcomputer", "Computer",
            new BlockComputer(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("xcomputer", 141).getInt(3979)).setBlockName("xcomputer").setCreativeTab(CreativeTabs.tabRedstone),
            null, TileEntityComputer.class,
            37, 36, 34, 32, 35, 33),
    REDSTONE_ADAPTER(true,
            "redstoneAdapter", "Redstone Adapter",
            new BlockRedstoneAdapter(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("redstoneAdapter", 142).getInt(3980)).setBlockName("redstoneAdapter").setCreativeTab(CreativeTabs.tabRedstone),
            null, TileEntityRedstoneAdapter.class,
            149, 148, 147, 147, 147, 147),
    RIBBON_CABLE(false,
            "ribbonCable", "Ribbon Cable",
            new BlockRibbonCable(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("ribbonCable", 143).getInt(3981)).setBlockName("ribbonCable").setCreativeTab(CreativeTabs.tabRedstone),
