...
public enum ElectroBlocks {
    ...
    COMPUTER(true,
            "xcomputer", "Computer",
            new BlockComputer(ConfigHandler.getCurrentConfig().getOrCreateBlockIdProperty("xcomputer", 3979).getInt(3979)).setBlockName("xcomputer").setCreativeTab(CreativeTabs.tabRedstone),
