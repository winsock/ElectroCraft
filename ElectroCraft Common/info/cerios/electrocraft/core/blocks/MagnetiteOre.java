...
public class MagnetiteOre extends Block {
	...
	public float getPlayerRelativeBlockHardness(EntityPlayer player,
			World world, int par3, int par4, int par5) {
		ItemStack stack = player.inventory.getCurrentItem();
		if (stack == null)
			return 0f;
		if (stack.itemID == Item.pickaxeGold.shiftedIndex
				|| stack.itemID == Item.pickaxeSteel.shiftedIndex)
			return 0f;
		return super.getPlayerRelativeBlockHardness(player, world, par3, par4,
				par5);
	}
