...
public class ConfigHandler {
	...
	public static void loadOrCreateConfigFile(String file) {
		modConfigFolder = new File(ElectroCraft.electroCraftSided.getBaseDir(),
				"config" + File.separator + "ElectroCraft");
		...
		if (!currentConfigFile.exists()) {
			try {
				...
				ElectroCraft.instance
						.getLogger()
						.severe("ElectroCraft: Unable to make config file! Do you have write permissions?");
			}
		}
