...
public enum ElectroItems {
    ...
    DRONE(false, "itemDrone", new ItemDrone(ConfigHandler.getCurrentConfig().get("item", "itemDrone", 30083).getInt(30083)).setIconIndex(6).setItemName("itemDrone").setCreativeTab(CreativeTabs.tabRedstone), "Drone");
