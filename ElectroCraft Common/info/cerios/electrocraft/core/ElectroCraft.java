...
import info.cerios.electrocraft.core.computer.ComputerSecurity;
...
@NetworkMod(channels = {"electrocraft"}, clientSideRequired = true, serverSideRequired = false, packetHandler=UniversialPacketHandler.class)
public class ElectroCraft implements IElectroCraft {
	...
	private ComputerSecurity securityManager;
	...
	public ComputerSecurity getSecurityManager() {
